...
radar = kriging.get_radar_for_locations(x, y, grid_extent, aggregate, block=2)
numpy.array(radar)
xi, yi = kriging.get_grid(aggregate, grid_extent)
...
#==============================================================================
tic = time()
rain_est_R, correction_factor = kriging.ked_R(x, y, z, radar, xi, yi, zi)
...
tic = time()
rain_est_py = kriging.ked_py(x, y, z, radar, xi, yi, zi)
